exports = function(changeEvent) {
  /*
    This database trigger copies the inserted document into another collection and records the time at which it was created to create a different view.
    
    Test it out:
    1. Go to www.atlas.mongodb.com/<project_id>/dataexplorer
    2. Add a database called 'db' and a collection called 'items'
    3. Insert a document in the 'items' collection
    3. Noice that the document in 'items_copy' collection has been inserted and updated
  */
