...
- **app_id:** your Atlas App Services App ID.
- **base_url** the App Services backend URL. This should be https://realm.mongodb.com in most cases.
...
`app_id` field with your App Services App ID. For help finding this ID, refer
...
in this client's `app_id` field in `app/src/main/res/values/atlasConfig.xml`
